...
public class Jogo extends JFrame implements ActionListener {
    ...
    public Jogo(){
        ...
        imagemSom= new ImageIcon("ProjetoFinal/Imagens/mute.png");
        ...
        urlNaveTitulo = Jogador.class.getResource("/ProjetoFinal/Imagens/naveAlien.gif");
        ImageIcon gifNaveAlien = new ImageIcon(urlNaveTitulo);
        alienTitulo = new JLabel(gifNaveAlien);
        alienTitulo.setBounds(50, 50, 250, 250);
    ...
    public  void actionPerformed(ActionEvent eve){
        ...
        if(source==muta){
            if(som==0){
                imagemSom= new ImageIcon("ProjetoFinal/Imagens/sound.png");
    ...
    public void moveAliens(){
        ...
        if(derrota==1){
            for (Component comp : janelas.getComponents()){
                if (comp != label && comp !=title && comp!=highScore && comp!=scorePartida && comp!=gameOver && comp!= alienTitulo) {
                    janelas.remove(comp);
                }
            }
