...
public class Teste extends JFrame implements ActionListener {
    ...
    public void recriaFileiras(){
        ...
        for(int i=0;i<numAliens;i++){
            Alien1 [] criaAlien1 = new Alien1[numAliens];
            criaAlien1[i]= new Alien1(x,y,janelas);
            x+=120;
            JLabel novoAlien1= criaAlien1[i].getAlien1();
...
class Alien1{
    ...
    Alien1(int x, int y, JLayeredPane camadas){
        ...
        url = Alien1.class.getResource("/ProjetoFinal/Imagens/alien1_4.gif");
        ImageIcon icon = new ImageIcon(url);
